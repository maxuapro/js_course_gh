...
const bind = (func, context, ...rest) => {
  if (!(typeof func === 'function')) {
    throw new Error('first parameter type is not a function type');
  } else if (!(typeof context === 'object')) {
    throw new Error('second parameter type is not an Object type');
  } else if (Array.isArray(context)) {
    throw new Error(`second parameter type can't be an Array type`);
  }
